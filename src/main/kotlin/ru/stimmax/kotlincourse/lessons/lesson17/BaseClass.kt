...
abstract class BaseClass(
    ...
    // ---  Поля protected доступны только в самом классе и в классах наследниках
    ...
    //--- Потому как в дочернем классе откуда вызывается getAll() функция generate() переопределена
